  ...
  return (
    <div className="px-4 pb-32 animate-in fade-in duration-500">
      <div className="flex items-center justify-between mb-8 px-2">
         <h2 className="text-3xl font-black text-white tracking-tighter">Executions</h2>
      ...
      <div className="flex flex-col gap-3">
        {trades.length === 0 ? (
          <div className="p-20 text-center text-zinc-600 font-black uppercase tracking-widest text-[10px]">No logs found</div>
        ) : (
